...
.k-slider .k-draghandle:focus, .k-slider .k-draghandle.k-state-focused {
    box-shadow: 0 0 0 11px rgba(21, 101, 192, 0.25);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(21, 101, 192, 0.25) 1px, rgba(21, 101, 192, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-calendar .k-range-split-start::after {
    left: -5px;
    right: auto;
    background-image: linear-gradient(to left, rgba(21, 101, 192, 0.25), transparent 100%);
}

.k-calendar .k-range-split-end::after {
    right: -5px;
    left: auto;
    background-image: linear-gradient(to right, rgba(21, 101, 192, 0.25), transparent 100%);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
    background-color: rgba(173, 201, 233, 0.2);
}
...
.k-spreadsheet-active-cell.k-right {
    box-shadow: inset 0 0 0 1px #1565c0, inset -1px 0 0 1px #1565c0;
}

.k-spreadsheet-active-cell.k-bottom {
    box-shadow: inset 0 0 0 1px #1565c0, inset 0 -1px 0 1px #1565c0;
}

.k-spreadsheet-active-cell.k-bottom.k-right {
    box-shadow: inset 0 0 0 1px #1565c0, inset -1px -1px 0 1px #1565c0;
}
...
.k-spreadsheet-has-comment::after {
    border-color: #1565c0 #1565c0 transparent transparent;
}
