...
@expander-header-focused-shadow: inset 0 0 0 2px rgba(0, 0, 0, .13);
...
@taskboard-column-bg: darken(@background, 3%);
...
@taskboard-card-title-text: @card-primary-text;
@taskboard-card-title-focus-text: darken( @card-primary-text, 13% );
@taskboard-card-title-hover-text: lighten( @card-primary-text, 13% );
...
@taskboard-card-selected-text: darken( @taskboard-card-text, 15% );
@taskboard-card-selected-bg: @taskboard-card-bg;
@taskboard-card-selected-border: darken( @card-primary-text, 15% );
...
@scheduler-yearview-indicator-bg: @selected-text-color;
@scheduler-yearview-indicator-selected-bg: contrast(@selected-text-color);
...
@orgchart-node-group-bg: darken(@background, 3%);
...
.k-mediaplayer {
    ...
    .k-toolbar .k-button.k-button-icon {
        margin-top: 0.2em;
    }
