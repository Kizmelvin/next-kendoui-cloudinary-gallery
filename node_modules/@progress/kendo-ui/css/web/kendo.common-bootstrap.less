...
@scrollview-pager-item-border-width: 0px;
...
// Expansion panel
@expander-spacing-y: @padding-y-lg;
...
@expander-content-padding-x: @padding-x-lg;
@expander-content-padding-y: @expander-content-padding-x;
