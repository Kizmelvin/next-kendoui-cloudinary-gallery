...
.k-chip-filled.k-chip-warning {
    border-color: transparent;
    color: #ffbb5b;
    background-color: rgba(255, 187, 91, 0.15);
}

.k-chip-filled.k-chip-error {
    border-color: transparent;
    color: #e3470e;
    background-color: rgba(227, 71, 14, 0.15);
}
...
.k-button-secondary.k-state-focused {
    box-shadow: 0 0 0 3px rgba(87, 152, 190, 0.5);
}
...
.k-calendar .k-calendar-view .k-today.k-state-focused .k-link {
    box-shadow: inset 0 0 0 1px #ff5c1a, inset 0 0 0 3px rgba(87, 152, 190, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-focus .k-link {
    box-shadow: inset 0 0 0 3px rgba(87, 152, 190, 0.5);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(255, 92, 26, 0.25) 1px, rgba(255, 92, 26, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-treeview .k-in.k-state-selected.k-state-focused {
    box-shadow: 0 0 0 2px rgba(255, 92, 26, 0.5);
}
