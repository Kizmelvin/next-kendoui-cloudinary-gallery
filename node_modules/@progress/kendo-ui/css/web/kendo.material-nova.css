...
.k-selection-single .k-chip-selected.k-chip-filled {
    border-color: transparent;
    color: #e51a5f;
    background-color: rgba(229, 26, 95, 0.12);
}
...
.k-switch-on .k-switch-container {
    background-color: rgba(229, 26, 95, 0.54);
}
...
.k-slider .k-draghandle:focus, .k-slider .k-draghandle.k-state-focused {
    box-shadow: 0 0 0 11px rgba(229, 26, 95, 0.25);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(229, 26, 95, 0.25) 1px, rgba(229, 26, 95, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-calendar .k-range-split-start::after {
    left: -5px;
    right: auto;
    background-image: linear-gradient(to left, rgba(229, 26, 95, 0.25), transparent 100%);
}

.k-calendar .k-range-split-end::after {
    right: -5px;
    left: auto;
    background-image: linear-gradient(to right, rgba(229, 26, 95, 0.25), transparent 100%);
}
...
.k-pager-numbers .k-link.k-state-selected {
    color: #e51a5f;
    background-color: rgba(229, 26, 95, 0.22);
}
...
.k-bottom-nav-solid.k-bottom-nav-secondary .k-bottom-nav-item:focus {
    background-color: rgba(166, 207, 232, 0.2);
}
...
.k-spreadsheet-selection {
    border-color: #e51a5f;
    background-color: rgba(229, 26, 95, 0.25);
    box-shadow: inset 0 0 0 1px #e51a5f;
}
...
.k-spreadsheet-active-cell.k-right {
    box-shadow: inset 0 0 0 1px #e51a5f, inset -1px 0 0 1px #e51a5f;
}

.k-spreadsheet-active-cell.k-bottom {
    box-shadow: inset 0 0 0 1px #e51a5f, inset 0 -1px 0 1px #e51a5f;
}

.k-spreadsheet-active-cell.k-bottom.k-right {
    box-shadow: inset 0 0 0 1px #e51a5f, inset -1px -1px 0 1px #e51a5f;
}
...
.k-spreadsheet-has-comment::after {
    border-color: #e51a5f #e51a5f transparent transparent;
}
...
[dir="rtl"] .k-spreadsheet .k-spreadsheet-has-comment::after {
    border-color: #e51a5f transparent transparent #e51a5f;
}
...
.k-chat .k-alt .k-bubble {
    ...
    color: #ffffff;
    background-color: #e51a5f;
    box-shadow: 0 1px 2px rgba(229, 26, 95, 0.2);
}
...
.k-chat .k-alt .k-state-selected .k-bubble {
    box-shadow: 0 3px 10px rgba(229, 26, 95, 0.4);
}
