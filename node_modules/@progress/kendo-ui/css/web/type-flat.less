...
@pivotgrid-headers-bg: shade( @pivotgrid-bg, 10% );
@pivotgrid-headers-text: @pivotgrid-text;
@pivotgrid-headers-border: @pivotgrid-border;

@pivotgrid-total-bg: shade( @pivotgrid-bg, 10% );
@pivotgrid-total-text: @pivotgrid-text;
...
// Chip
@chip-base-bg: @button-background-color;
