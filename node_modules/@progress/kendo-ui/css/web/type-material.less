...
@card-focus-shadow: 0 5px 5px -3px rgba(contrast(@background), 0.2), 0 8px 10px 1px rgba(contrast(@background), 0.14), 0 3px 14px 2px rgba(contrast(@background), 0.12);
...
@card-focus-callout-box-shadow-n: null;
@card-focus-callout-box-shadow-e: null;
@card-focus-callout-box-shadow-s: null;
@card-focus-callout-box-shadow-w: null;
...
@tilelayout-card-focus-shadow: 0 5px 5px -3px rgba(contrast(@tilelayout-bg), 0.2), 0 8px 10px 1px rgba(contrast(@tilelayout-bg), 0.14), 0 3px 14px 2px rgba(contrast(@tilelayout-bg), 0.12);
...
@expander-header-sub-title-opacity: .62;

@expander-header-hover-bg: rgba( black, .04 );
@expander-header-focused-bg: rgba( black, .12 );
...
@taskboard-card-header-text: @taskboard-card-text;
...
@pivotgrid-headers-text: @pivotgrid-text;
