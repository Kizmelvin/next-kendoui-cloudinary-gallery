...
.k-chip-primary:focus, .k-chip-primary.k-chip-focus {
    box-shadow: 0 0 0 2px rgba(25, 132, 200, 0.16);
}
...
.k-popup .k-list .k-item > .k-group::before {
    border-color: #515967 #515967 transparent transparent;
}

.k-rtl.k-popup .k-list .k-item > .k-group::before,
[dir="rtl"] .k-popup .k-list .k-item > .k-group::before {
    border-color: #515967 transparent transparent #515967;
}
...
.k-switch:hover .k-switch-container, .k-switch.k-state-hover .k-switch-container {
    box-shadow: inset 0 0 0 1px #b8bac0;
}
...
.k-fab-primary:active {
    border-color: #1779b8;
    background-color: #1779b8;
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(25, 132, 200, 0.4);
}
...
.k-fab-secondary:active {
    border-color: #e0e0e0;
    background-color: #e0e0e0;
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(243, 243, 244, 0.4);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(25, 132, 200, 0.25) 1px, rgba(25, 132, 200, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-chat .k-message-box.k-state-focused {
    box-shadow: 0 0 40px rgba(81, 89, 103, 0.1);
}
