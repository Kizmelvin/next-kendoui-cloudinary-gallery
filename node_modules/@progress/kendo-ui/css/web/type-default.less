...
@card-focus-border: rgba(black, .15);
...
@expander-header-hover-bg: shade(@expander-bg, 10%);
...
@scheduler-tooltip-bg: if(@is-dark-theme, lighten(@scheduler-background-color, 20%), null);
...
@pivotgrid-headers-bg: if(@is-dark-theme, @alt-background-color, @header-background-color);
