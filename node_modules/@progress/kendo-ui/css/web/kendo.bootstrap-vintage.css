...
.k-selection-single .k-chip-selected.k-chip-filled {
    border-color: transparent;
    color: #744662;
    background-color: rgba(116, 70, 98, 0.12);
}
...
.k-chip-filled.k-chip-success {
    border-color: transparent;
    color: #8dba4f;
    background-color: rgba(141, 186, 79, 0.15);
}

.k-chip-filled.k-chip-warning {
    border-color: transparent;
    color: #e8be68;
    background-color: rgba(232, 190, 104, 0.15);
}

.k-chip-filled.k-chip-error {
    border-color: transparent;
    color: #b42a58;
    background-color: rgba(180, 42, 88, 0.15);
}

.k-chip-filled.k-chip-info {
    border-color: transparent;
    color: #70c1de;
    background-color: rgba(112, 193, 222, 0.15);
}
...
.k-button-secondary.k-state-focused {
    box-shadow: 0 0 0 3px rgba(218, 210, 189, 0.5);
}
...
.k-popup .k-list .k-item > .k-group::before {
    border-color: #494138 #494138 transparent transparent;
}

.k-rtl.k-popup .k-list .k-item > .k-group::before,
[dir="rtl"] .k-popup .k-list .k-item > .k-group::before {
    border-color: #494138 transparent transparent #494138;
}
...
.k-toolbar .k-overflow-anchor {
    ...
    margin: 0;
    padding: 0.5rem;
    width: calc(1.5em + 0.75rem + 2px + 1rem);
    height: 100%;
    border-width: 0;
    border-color: inherit;
    box-sizing: border-box;
...
.k-switch-on.k-state-disabled .k-switch-container {
    background-color: rgba(116, 70, 98, 0.5);
}
...
.k-fab-square.k-fab-md {
    width: calc(1.25em + 2rem);
    height: calc(1.25em + 2rem);
}

.k-fab-square.k-fab-lg {
    width: calc(1.25em + 3rem);
    height: calc(1.25em + 3rem);
}
...
.k-calendar .k-calendar-view .k-today.k-state-focused .k-link {
    box-shadow: inset 0 0 0 1px #744662, inset 0 0 0 3px rgba(218, 210, 189, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-focus .k-link {
    box-shadow: inset 0 0 0 3px rgba(218, 210, 189, 0.5);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(116, 70, 98, 0.25) 1px, rgba(116, 70, 98, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-treeview .k-in.k-state-selected.k-state-focused {
    box-shadow: 0 0 0 2px rgba(116, 70, 98, 0.5);
}
...
.k-grid-header .k-header-column-menu {
    ...
    position: absolute;
    right: 0.5rem;
    bottom: calc(0.5rem + 0.75em - 0.75em - 0.375rem);
    z-index: 1;
}
...
.k-header > .k-cell-inner {
    margin: -0.5rem calc(-1 * (1.5em + 0.75rem + 2px - 0.5rem)) -0.5rem -0.5rem;
}

.k-filterable > .k-cell-inner {
    margin: -0.5rem calc(-1 * (1.5em + 0.75rem + 2px)) -0.5rem -0.5rem;
}
...
.k-rtl .k-header > .k-cell-inner {
    margin-right: -0.5rem;
    margin-left: calc(-1 * (1.5em + 0.75rem + 2px - 0.5rem));
}
...
.k-rtl .k-filterable > .k-cell-inner {
    margin-right: -0.5rem;
    margin-left: calc(-1 * (1.5em + 0.75rem + 2px));
}
...
.k-taskboard-column-new {
    max-height: calc(1.5em + 0.75rem + 2px + 1.5rem);
}
...
.k-editor-toolbar .k-overflow-anchor {
    ...
    padding: 0.5rem;
    width: calc(1.5em + 0.75rem + 2px + 1rem);
    height: calc(1.5em + 0.75rem + 2px + 1rem);
    position: relative;
}
