...
.k-chip-filled.k-chip-info {
    ...
    color: #2498bc;
    background-color: rgba(36, 152, 188, 0.12);
}
...
.k-chip-outline.k-chip-info {
    border-color: rgba(36, 152, 188, 0.54);
    color: #2498bc;
    background-color: transparent;
}
...
.k-fab-info:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(36, 152, 188, 0.4);
}
