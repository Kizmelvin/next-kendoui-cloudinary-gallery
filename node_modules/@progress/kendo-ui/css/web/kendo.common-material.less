 ...
 */
@import "Material/_variables.less";
...
@expander-header-padding-x: (@padding-x * 1.5);
@expander-header-padding-y: (@padding-y * 2);
@expander-indicator-margin-x: (@padding-x / 2);

@expander-content-padding-x: (@padding-x * 1.5);
@expander-content-padding-y: (@padding-y * 3);
...
@grid-column-menu-popup-padding-y: @padding-y-lg;

@grid-column-menu-item-padding-x: @padding-x;
@grid-column-menu-item-padding-y: @padding-y-lg;

@grid-column-menu-list-item-padding-x: @padding-x;
@grid-column-menu-list-item-padding-y: 0;
