...
// Expansion panel
@expander-spacing-y: 8px;
@expander-font-family: @font-family;
@expander-font-size: @font-size;
@expander-line-height: @line-height;
@expander-border-width: 1px;

@expander-header-padding-x: @padding-x-lg;
@expander-header-padding-y: (@padding-y * 2);
@expander-indicator-margin-x: calc( (@padding-x / 2) * 1.5 );

@expander-content-padding-x: 20px;
@expander-content-padding-y: 20px;
...
@bottom-nav-item-min-height: calc( (@icon-size * 2.5) + (@bottom-nav-item-padding-x * 2) );
...
@grid-column-menu-popup-padding-y: @padding-y;

@grid-column-menu-item-padding-x: @padding-x-lg;
@grid-column-menu-item-padding-y: @padding-y-sm;

@grid-column-menu-list-item-padding-x: @padding-x-lg;
@grid-column-menu-list-item-padding-y: @padding-y-sm;

@grid-column-menu-filter-container-padding-x: @padding-x-lg;
@grid-column-menu-filter-container-padding-y: @padding-y-sm;
...
@taskboard-column-new-calc-height: calc( @input-offset + (@taskboard-column-header-padding-y * 2) + 1em);
...
// Tabstrip
@tabstrip-padding-x: 0;
@tabstrip-padding-y: 0;
@tabstrip-border-width: 0;

@tabstrip-items-wrap-border-width: 0;

@tabstrip-item-padding-x: 0;
@tabstrip-item-padding-y: 8px;
@tabstrip-item-border-width: 0;
@tabstrip-item-border-radius: 0;
@tabstrip-item-gap: 1.5em;
...
@chip-selected-icon-size: 24px;
@chip-selected-icon-offset: 6px;
@chip-selected-icon-no-icon-offset: @chip-selected-icon-offset;
@chip-selected-icon-font-size: @chip-font-size;

@chip-content-padding-x: 6px;

@chip-icons-size: 24px;
@chip-icon-margin: 0px;
@chip-remove-icon-margin: 0px;
