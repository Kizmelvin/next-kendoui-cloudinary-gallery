...
.k-selection-single .k-chip-selected.k-chip-filled {
    border-color: rgba(191, 112, 204, 0.2);
    color: #bf70cc;
...
.k-chip-primary:focus, .k-chip-primary.k-chip-focus {
    box-shadow: 0 0 0 2px rgba(191, 112, 204, 0.16);
}
...
.k-fab-primary:active {
    border-color: #b067bc;
    background-color: #b067bc;
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(191, 112, 204, 0.4);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(191, 112, 204, 0.25) 1px, rgba(191, 112, 204, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
