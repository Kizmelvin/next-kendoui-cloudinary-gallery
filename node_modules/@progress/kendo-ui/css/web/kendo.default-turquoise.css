...
.k-selection-single .k-chip-selected.k-chip-filled {
    border-color: rgba(40, 191, 186, 0.2);
    color: #28bfba;
...
.k-chip-primary:focus, .k-chip-primary.k-chip-focus {
    box-shadow: 0 0 0 2px rgba(40, 191, 186, 0.16);
}
...
.k-fab-primary:active {
    border-color: #25b0ab;
    background-color: #25b0ab;
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(40, 191, 186, 0.4);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(40, 191, 186, 0.25) 1px, rgba(40, 191, 186, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
