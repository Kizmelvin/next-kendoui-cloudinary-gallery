...
@taskboard-column-bg: @secondary-widget-background-color;
...
@popover-header-text: @popover-text;
@popover-header-border: @popover-border;
...
@orgchart-node-group-bg: @secondary-widget-background-color;
...
@pivotgrid-headers-bg: @background;
...
@pivotgrid-focus-shadow: inset 0 0 0 1px @accent;
