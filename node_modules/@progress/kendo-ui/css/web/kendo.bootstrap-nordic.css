...
.k-chip-filled.k-chip-success {
    border-color: transparent;
    color: #90bf4f;
    background-color: rgba(144, 191, 79, 0.15);
}
...
.k-chip-filled.k-chip-error {
    border-color: transparent;
    color: #d31038;
    background-color: rgba(211, 16, 56, 0.15);
}

.k-chip-filled.k-chip-info {
    border-color: transparent;
    color: #01a8c1;
    background-color: rgba(1, 168, 193, 0.15);
}
...
.k-button-secondary.k-state-focused {
    box-shadow: 0 0 0 3px rgba(214, 229, 233, 0.5);
}
...
.k-switch-on.k-state-disabled .k-switch-container {
    background-color: rgba(231, 96, 123, 0.5);
}
...
.k-calendar .k-calendar-view .k-today.k-state-focused .k-link {
    box-shadow: inset 0 0 0 1px #e7607b, inset 0 0 0 3px rgba(214, 229, 233, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-focus .k-link {
    box-shadow: inset 0 0 0 3px rgba(214, 229, 233, 0.5);
}
...
.k-treeview .k-in.k-state-selected.k-state-focused {
    box-shadow: 0 0 0 2px rgba(231, 96, 123, 0.5);
}
