...
.k-multiselect-wrap.k-multiselect-wrap-arrow > .k-clear-value {
    right: calc(@multiselect-clear-icon-offset-with-arrow);
}
...
.k-rtl {
    ...
    .k-multiselect-wrap.k-multiselect-wrap-arrow > .k-clear-value {
        left: calc(@multiselect-clear-icon-offset-with-arrow);
        right: auto;
    }
...
.k-input-suffix {
    ...
    > .k-icon {
        width: calc((@line-height * @font-size) + (@input-padding-y * 2));
        height: calc((@line-height * @font-size) + (@input-padding-y * 2));
        display: inline-flex;
