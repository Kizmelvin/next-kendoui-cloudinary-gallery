...
.k-selection-single .k-chip-selected.k-chip-filled {
    border-color: rgba(123, 210, 246, 0.2);
    color: #7bd2f6;
...
.k-chip-filled.k-chip-success {
    ...
    color: #3ea44e;
    background-color: rgba(62, 164, 78, 0.12);
}
...
.k-chip-filled.k-chip-error {
    ...
    color: #d92800;
    background-color: rgba(217, 40, 0, 0.12);
}

.k-chip-filled.k-chip-info {
    border-color: rgba(0, 123, 195, 0.3);
    color: #007bc3;
    background-color: rgba(0, 123, 195, 0.12);
}
...
.k-chip-outline.k-chip-success {
    border-color: rgba(62, 164, 78, 0.54);
    color: #3ea44e;
    background-color: transparent;
}
...
.k-chip-outline.k-chip-error {
    border-color: rgba(217, 40, 0, 0.54);
    color: #d92800;
    background-color: transparent;
}

.k-chip-outline.k-chip-info {
    border-color: rgba(0, 123, 195, 0.54);
    color: #007bc3;
    background-color: transparent;
}

.k-chip-primary:focus, .k-chip-primary.k-chip-focus {
    box-shadow: 0 0 0 2px rgba(123, 210, 246, 0.16);
}
...
.k-popup .k-list .k-item > .k-group::before {
    border-color: #003f59 #003f59 transparent transparent;
}

.k-rtl.k-popup .k-list .k-item > .k-group::before,
[dir="rtl"] .k-popup .k-list .k-item > .k-group::before {
    border-color: #003f59 transparent transparent #003f59;
}
...
.k-switch:hover .k-switch-container, .k-switch.k-state-hover .k-switch-container {
    box-shadow: inset 0 0 0 1px #89afc0;
}
...
.k-fab-primary:active {
    border-color: #71c1e2;
    background-color: #71c1e2;
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(123, 210, 246, 0.4);
}
...
.k-fab-secondary:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(218, 236, 244, 0.4);
}
...
.k-fab-info:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(0, 123, 195, 0.4);
}
...
.k-fab-success:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(62, 164, 78, 0.4);
}
...
.k-fab-warning:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 152, 0, 0.4);
}
...
.k-fab-error:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(217, 40, 0, 0.4);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(123, 210, 246, 0.25) 1px, rgba(123, 210, 246, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-chat .k-message-box.k-state-focused {
    box-shadow: 0 0 40px rgba(0, 63, 89, 0.1);
}
