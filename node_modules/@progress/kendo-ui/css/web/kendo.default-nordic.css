...
.k-selection-single .k-chip-selected.k-chip-filled {
    border-color: rgba(231, 96, 123, 0.2);
    color: #e7607b;
...
.k-chip-filled.k-chip-success {
    border-color: rgba(144, 191, 79, 0.3);
    color: #90bf4f;
    background-color: rgba(144, 191, 79, 0.12);
}
...
.k-chip-filled.k-chip-error {
    border-color: rgba(211, 16, 56, 0.3);
    color: #d31038;
    background-color: rgba(211, 16, 56, 0.12);
}

.k-chip-filled.k-chip-info {
    border-color: rgba(1, 168, 193, 0.3);
    color: #01a8c1;
    background-color: rgba(1, 168, 193, 0.12);
}
...
.k-chip-outline.k-chip-success {
    border-color: rgba(144, 191, 79, 0.54);
    color: #90bf4f;
    background-color: transparent;
}
...
.k-chip-outline.k-chip-error {
    border-color: rgba(211, 16, 56, 0.54);
    color: #d31038;
    background-color: transparent;
}

.k-chip-outline.k-chip-info {
    border-color: rgba(1, 168, 193, 0.54);
    color: #01a8c1;
    background-color: transparent;
}

.k-chip-primary:focus, .k-chip-primary.k-chip-focus {
    box-shadow: 0 0 0 2px rgba(231, 96, 123, 0.16);
}
...
.k-checkbox.ng-invalid.ng-dirty {
    border-color: rgba(211, 16, 56, 0.5);
}
...
.k-fab-primary:active {
    border-color: #d55871;
    background-color: #d55871;
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(231, 96, 123, 0.4);
}
...
.k-fab-secondary:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(214, 229, 233, 0.4);
}
...
.k-fab-info:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(1, 168, 193, 0.4);
}
...
.k-fab-success:active {
    border-color: #84b049;
    background-color: #84b049;
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(144, 191, 79, 0.4);
}
...
.k-fab-warning:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(255, 200, 87, 0.4);
}
...
.k-fab-error:active {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12), 0 3px 5px rgba(0, 0, 0, 0.2), 0px 3px 4px rgba(211, 16, 56, 0.4);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(231, 96, 123, 0.25) 1px, rgba(231, 96, 123, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
