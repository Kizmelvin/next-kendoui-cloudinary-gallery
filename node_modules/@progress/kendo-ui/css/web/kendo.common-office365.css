...
.k-input-suffix > .k-icon {
  width: calc(20.00000002px + 0.35714286em);
  height: calc(20.00000002px + 0.35714286em);
  display: -ms-inline-flexbox;
  display: inline-flex;
  -ms-flex-flow: row nowrap;
      flex-flow: row nowrap;
...
.k-autocomplete.k-state-border-down > .k-clear-value,
.k-combobox > .k-dropdown-wrap.k-state-border-down > .k-clear-value {
  margin-top: -1px;
}
.k-popup.k-list-container,
.k-popup.k-calendar-container {
