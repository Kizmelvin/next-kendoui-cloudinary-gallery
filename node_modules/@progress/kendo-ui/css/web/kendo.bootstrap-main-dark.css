...
.k-calendar .k-calendar-view .k-today.k-state-focused .k-link {
    box-shadow: inset 0 0 0 1px #0d6efd, inset 0 0 0 3px rgba(52, 58, 64, 0.5);
}
...
.k-calendar .k-calendar-td.k-state-focus .k-link {
    box-shadow: inset 0 0 0 3px rgba(52, 58, 64, 0.5);
}
...
.k-chat .k-message-box.k-state-focused {
    box-shadow: 0 0 40px rgba(222, 226, 230, 0.1);
}
...
.k-chat .k-toolbar-box .k-scroll-button {
    background-color: #050505;
    box-shadow: 0 0 20px 5px #050505;
}
