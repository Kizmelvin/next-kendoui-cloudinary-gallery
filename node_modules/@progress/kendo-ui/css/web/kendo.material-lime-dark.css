...
.k-checkbox.k-checked {
    background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3e%3cpath fill='none' stroke='%23000000' stroke-width='3' d='M4.1,12.7 9,17.6 20.3,6.3'/%3e%3c/svg%3e");
}

.k-checkbox:indeterminate,
.k-checkbox.k-indeterminate,
.k-checkbox.k-state-indeterminate {
    background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'%3e%3cpath fill='none' stroke='%23000000' stroke-width='3' d='M4 10h12'/%3e%3c/svg%3e");
}
...
.k-slider .k-draghandle:focus, .k-slider .k-draghandle.k-state-focused {
    box-shadow: 0 0 0 11px rgba(205, 220, 57, 0.25);
}
...
.k-calendar .k-range-mid {
    background-image: linear-gradient(transparent 1px, rgba(205, 220, 57, 0.25) 1px, rgba(205, 220, 57, 0.25) calc(100% - 1px), transparent calc(100% - 1px));
}
...
.k-calendar .k-range-split-start::after {
    left: -5px;
    right: auto;
    background-image: linear-gradient(to left, rgba(205, 220, 57, 0.25), transparent 100%);
}

.k-calendar .k-range-split-end::after {
    right: -5px;
    left: auto;
    background-image: linear-gradient(to right, rgba(205, 220, 57, 0.25), transparent 100%);
}
...
.k-bottom-nav-solid.k-bottom-nav-primary .k-bottom-nav-item:focus {
    background-color: rgba(72, 77, 20, 0.2);
}
...
.k-spreadsheet-active-cell.k-right {
    box-shadow: inset 0 0 0 1px #cddc39, inset -1px 0 0 1px #cddc39;
}

.k-spreadsheet-active-cell.k-bottom {
    box-shadow: inset 0 0 0 1px #cddc39, inset 0 -1px 0 1px #cddc39;
}

.k-spreadsheet-active-cell.k-bottom.k-right {
    box-shadow: inset 0 0 0 1px #cddc39, inset -1px -1px 0 1px #cddc39;
}
...
.k-chat .k-alt .k-bubble {
    ...
    color: #000000;
    background-color: #cddc39;
    box-shadow: 0 1px 2px rgba(205, 220, 57, 0.2);
}
...
.k-chat .k-alt .k-state-selected .k-bubble {
    box-shadow: 0 3px 10px rgba(205, 220, 57, 0.4);
}
